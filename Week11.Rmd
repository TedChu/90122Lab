...
* In Lab 11, we will follow Lab 2.2 of *Spatio-Temporal Statistics with R*. You can download the electronic pdf through https://spacetimewithr.org/. 
  ...
  + In Lab 2.1 -- 2.2 of Spatio-Temporal Statistics with R, functions from package *dplyr* and *tidyr* are used for data cleaning. Please use help file to obtain more information. (These packages are widely used for data cleaning. However, this is not the focus of this subject.)
...
* The plot will be produced by package *ggplot2*. The new function here
  + geom_path: add US states map
