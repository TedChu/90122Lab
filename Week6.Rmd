---
title: 'Week 6: Visualisation of Spatial Data--ggplot'
---
...
## pv dataset
The following example is from "https://eriqande.github.io/rep-res-eeb-2017/ggplot2-intro-lecture.html". 

The pv dataset includes information of  the history of pole-vaulting world record "http://en.wikipedia.org/wiki/Men's_pole_vault_world_record_progression". Here, the data is already stored in \textsf{pv.RData}. 

First, read the RData set. Remember to set the right working directory. 
...
An alternative (and better) way for visulatization of spatial objects in ggplot2 is to use *geom_sf* function. 
