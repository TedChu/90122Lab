...
* Key points
  ...
  + coord_fixed(): It fixes the relationship between one unit in the y direction and one unit in the x direction. The middle latitude is 40, and therefore, $1/cos(2\pi/9) \approx 1.3$
