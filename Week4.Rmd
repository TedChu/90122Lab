---
title: 'Week 4: Visualisation of Spatial Data--sf'
---
...
* The shapefile here is named *Aus-Melbourne02*, which records information from all LGA in Greater Melbourne. It is downloaded from https://www.igismap.com/australia-shapefile-download/ (This website also has shapefile of other Australian regions and cities). Here is some extra information: 
...
In https://discover.data.vic.gov.au/dataset/2015-local-government-area-profiles, many statistics for each LGA in Victoria is recorded for 2015, and it is available in *LGAData.csv*. It includes around 400 variables. 
...
# Reference
For more details of *sf* package, please see 