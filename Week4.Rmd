...
* Argument: 
  ...
  + method: the method used to compute p-value. "Chisq" (the method mentioned in this class)
...
* Argument: 
  ...
  + nrank: similar to deciding the significance level
    + Note that (5+5)/200 = 0.05, and therefore, it is a similar to test at <span style="color: red;">"significance level"</span> = 0.05 
